...
def download_image(filename, save_path):
    ...
    if not img_url:
        # Check wikimedia commons directly if not found on en.wikipedia
...
download_image("Coat_of_arms_of_Central_Kalimantan.svg", "public/img/logo-kalteng.svg")
download_image("PT_Jasa_Raharja_(Persero).svg", "public/img/logo-jasaraharja.svg")
download_image("Lambang_Polda_Kalteng.png", "public/img/logo-polda.png")
